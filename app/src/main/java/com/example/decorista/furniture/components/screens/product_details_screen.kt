...
import com.example.decorista.furniture.components.navigation.Checkout
...
import com.example.decorista.ui.theme.Background_1
import com.example.decorista.ui.theme.DarkOrange
import com.example.decorista.ui.theme.GrayColor
import com.example.decorista.ui.theme.LightGray_1
import com.example.decorista.ui.theme.LightOrange
...
fun ProductDetailScreen(  navHostController: NavHostController
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        Image(
            painter = painterResource(id = R.drawable.sofa1seater), contentDescription = "",
            modifier = Modifier
                .fillMaxWidth()
                .height(250.dp),
...
fun BottomBarItem(
    ...
    Column(
        modifier = modifier.fillMaxWidth().background(brush = lightGradient)
    ) {
...
fun RatingRow() {
    ...
    val personIcons = listOf(
        R.drawable.person1_resized,
        R.drawable.person2_resized,
        R.drawable.person3_resized,
        R.drawable.perosn4_resized
    )
...
fun ProductCountButton1(
    ...
    TextButton(
        ...
        Icon(Icons.Default.Close, contentDescription = "", tint = DarkOrange)
    }
